...
REPO_DIR="/Users/lukasz/Documents/variousprojects"
...
if [[ $# -gt 0 ]]; then
  git -C "${REPO_DIR}" add summer26 README.md .gitignore .github
...
echo "Next steps:"
echo "  git -C ${REPO_DIR} add summer26 README.md .gitignore .github"
